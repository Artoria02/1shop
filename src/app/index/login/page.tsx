...
export default function BuyerLoginPage() {
  ...
  return (
    <div style={{ maxWidth: 400, margin: "100px auto", padding: "0 16px" }}>
      <h1 style={{ fontSize: 24, marginBottom: 24 }}>买家登录</h1>
      ...
      <p style={{ marginTop: 16, fontSize: 13, color: "#666", textAlign: "center" }}>
        还没有账号？
        <Link href="/index/register" style={{ color: "#111", fontWeight: 500 }}>去注册</Link>
      </p>
    </div>
  );
}
...
function PasswordLoginForm() {
  const [state, formAction] = useActionState(buyerLoginAction, loginInitial);
...
function PhoneLoginForm() {
  const [loginState, loginAction] = useActionState(phoneLoginAction, loginInitial);
